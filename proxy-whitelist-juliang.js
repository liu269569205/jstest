...
//初始化服务调用所需公共必要参数
const user_id = '1019622';
const accessKey = '9cd797ed39d541fdb5a4a11357e9182a';
...
async function addip(ip) {
  ...
  return new Promise(async resolve => {
       var result = client.dynamicSetWhiteIp(dyKey,dyTradeNo,ip);
		console.log(result);
		resolve();
    })
}
async function dynamicReplace(ip) {
  ...
  return new Promise(async resolve => {
       var result = client.dynamicReplace(dyKey,dyTradeNo,ip,{reset:1});
		console.log(result);
		resolve();
    })
}
