const _0x49dfef = _0x5370a4("电信营业厅"),
  ...
  { exec: _0x3898d1 } = require("child_process"),
  { CookieJar: _0x4f58d7 } = require("tough-cookie"),
...
const _0x5370da = "./chinaTelecom_cache.json",
  _0x3ed712 =
    "Mozilla/5.0 (Linux; U; Android 12; zh-cn; ONEPLUS A9000 Build/QKQ1.190716.003) AppleWebKit/533.1 (KHTML, like Gecko) Version/5.0 Mobile Safari/533.1",
...
function _0x1519a6(
  ...
  return _0x5e650c[_0xa8ae5c]
    .encrypt(
      _0x5e650c.enc.Utf8.parse(_0xa81bc3),
      _0x5e650c.enc.Utf8.parse(_0x5af061),
      {
...
function _0x4e4355() {
  try {
    _0x5336b3.writeFileSync(
      _0x5370da,
      JSON.stringify(_0x1d3d6d, null, 4),
      "utf-8",
    );
  } catch (_0x1c3791) {
    console.log("保存缓存出错");
...
function _0x11cae0() {
  ...
  _0x4fe84e = _0x4fe84e.concat(
    _0x39bc5b.map((_0x425dac) => 'grep -v "' + _0x425dac + ' "'),
  );
...
class _0x9d1851 {
  ...
  set_cookie(_0x309397, _0x3ab012, _0x4a8547, _0x1320cb, _0x482400 = {}) {
    this.cookieJar.setCookieSync(
      _0x309397 + "=" + _0x3ab012 + "; Domain=" + _0x4a8547 + ";",
      "" + _0x1320cb,
    );
  }
          ...
          if (_0x54807f.includes(_0x19ce7b)) {
            ...
            if (_0x497c09.includes(_0x5c8c40)) {
              ...
              if (_0x58b4a1.includes(_0x19ce7b)) {
                ...
                if (_0x42b498) {
                  _0x2ef704 > 3 &&
                    !_0x25d788.includes(_0x42b498) &&
                    (_0x42b498
                      ? this.log(
                          "请求[" + _0x1684d3 + "]返回[" + _0x42b498 + "]",
                        )
                      : this.log(
                          "请求[" +
                            _0x1684d3 +
...
class _0x3f433d extends _0x280825 {
  constructor(_0x5669ce) {
    ...
    this.uuid = [
      _0x49dfef.randomPattern("xxxxxxxx"),
      _0x49dfef.randomPattern("xxxx"),
      _0x49dfef.randomPattern("4xxx"),
      _0x49dfef.randomPattern("xxxx"),
      _0x49dfef.randomPattern("xxxxxxxxxxxx"),
    ];
  ...
  encode_phone() {
    ...
    for (let _0x51660a in _0xd2389f) {
      _0xd2389f[_0x51660a] = String.fromCharCode(
        _0xd2389f[_0x51660a].charCodeAt(0) + 2,
      );
    }
  ...
  async login(_0x2971d3 = {}) {
    ...
    try {
      let _0x3ae9d0 = _0x49dfef.time("yyyyMMddhhmmss"),
          ...
          json: {
            ...
            content: {
              ...
              fieldData: {
                loginType: "4",
                accountType: "",
                loginAuthCipherAsymmertric: _0x13a631.encrypt(
                  _0x16bc9b,
                  "base64",
                ),
        ...
        { result: _0x3cbd6a, statusCode: _0x4338ff } =
          await this.request(_0x807c6e),
        _0x107431 = _0x49dfef.get(
          _0x3cbd6a?.["responseData"],
          "resultCode",
          -1,
        );
      ...
      if (_0x107431 == "0000") {
        ...
        let _0xf8ba30 =
          _0x3cbd6a?.["msg"] ||
          _0x3cbd6a?.["responseData"]?.["resultDesc"] ||
          _0x3cbd6a?.["headerInfos"]?.["reason"] ||
          "";
  ...
  async get_ticket(_0x3e5067 = {}) {
    ...
    try {
      ...
      let { result: _0x9f4220, statusCode: _0x1e891f } =
      ...
      !_0x252ee2 &&
        (!_0x3e5067.retry && (await this.login())
          ? ((_0x3e5067.retry = true),
            (_0x252ee2 = await this.get_ticket(_0x3e5067)))
          : (this.log("没有获取到ticket[" + _0x1e891f + "]: "),
            _0x9f4220 && this.log(": " + JSON.stringify(_0x9f4220))));
    } catch (_0x1c9e54) {
  ...
  encrypt_para(_0x217db5) {
    let _0x1c768f =
      typeof _0x217db5 == "string" ? _0x217db5 : JSON.stringify(_0x217db5);
  ...
  async userCoinInfo(_0x3a27b0 = false, _0x2a9f2e = {}) {
    ...
    try {
      ...
      let _0x55424b = {
        ...
        { result: _0x18ad00, statusCode: _0x3e695c } =
  ...
  async userStatusInfo(_0x10c627 = {}) {
    try {
      ...
      // 第一次请求
      {
        ...
        let { result: _0x39cfe5, statusCode: _0x5e556e } = await this.request(
            _0x49dfef.copy(_0x16b897),
          ),
          _0x509ab0 = _0x49dfef.get(_0x39cfe5, "resoultCode", _0x5e556e);
        if (_0x509ab0 == 0) {
          let { isSign: _0x1d403c } = _0x39cfe5?.["data"];
          _0x1d403c ? this.log("今天已签到") : await this.doSign();
        } else {
          let _0x11bda2 =
            _0x39cfe5?.["msg"] ||
            _0x39cfe5?.["resoultMsg"] ||
            _0x39cfe5?.["error"] ||
            "";
      ...
      // 第二次请求
      {
        ...
        let { result: _0xf4c969, statusCode: _0x34b777 } = await this.request(
            _0x49dfef.copy(_0x16b897),
          ),
  ...
  async continueSignRecords(_0x716c04 = {}) {
    ...
    try {
      ...
      let _0x3db199 = {
        ...
        { result: _0xcdce9f, statusCode: _0x167568 } =
  ...
  async doSign(_0x3d1e97 = {}) {
    ...
    try {
      let _0x2c6ae2 = {
        ...
        { result: _0x4a380a, statusCode: _0x39f295 } =
      ...
      if (_0x66dfe4 == 0) {
        ...
        if (_0x3199d0 == 1) {
          ...
          this.log(
            "签到成功，获得" + (_0x4a380a?.["data"]?.["coin"] || 0) + "金豆",
            _0x241cc1,
          );
          ...
          this.log(
            "签到失败[" + _0x3199d0 + "]: " + _0x4a380a.data.msg,
            _0x16b3bf,
          );
        }
      } else {
  ...
  async exchangePrize(_0x503199 = {}) {
    ...
    try {
      ...
      let _0x275dee = {
        ...
        { result: _0x122edb, statusCode: _0x7493f8 } =
      ...
      if (_0x32ecff == 0) {
        ...
        if (_0xfbfebb == 0) {
          ...
          this.log(
            "连签" +
              _0x15d8af +
              "天抽奖: " +
              _0x122edb?.["prizeDetail"]?.["biz"]?.["winTitle"],
            _0x51aac0,
          );
        } else {
          ...
          this.log(
            "连签" + _0x15d8af + "天抽奖失败[" + _0xfbfebb + "]: " + _0x36ea79,
            _0x513b8a,
          );
        }
      } else {
        let _0x2f0e88 =
          _0x122edb?.["msg"] ||
          _0x122edb?.["resoultMsg"] ||
          _0x122edb?.["error"] ||
          "";
        this.log(
          "连签" + _0x15d8af + "天抽奖错误[" + _0x32ecff + "]: " + _0x2f0e88,
        );
      }
    } catch (_0x57662f) {
  ...
  async receiveReward(_0x1f06a0, _0x27d046 = {}) {
    ...
    try {
      ...
      let _0x4db2f8 = {
        ...
        { result: _0x514940, statusCode: _0x5641f8 } =
          await this.request(_0x4db2f8),
        _0x1559d6 = _0x49dfef.get(_0x514940, "resoultCode", _0x5641f8);
      if (_0x1559d6 == 0) {
        this.log(
          "领取任务[" + _0x408e82 + "]奖励成功: " + _0x514940?.["resoultMsg"],
        );
      } else {
        let _0xa69dbc =
          _0x514940?.["msg"] ||
          _0x514940?.["resoultMsg"] ||
          _0x514940?.["error"] ||
          "";
        this.log(
          "领取任务[" +
  ...
  async openMsg(_0x51c539, _0x46c92d = {}) {
    ...
    try {
      ...
      let _0x1c217b = {
        ...
        { result: _0xb6f7bf, statusCode: _0x41e108 } =
          await this.request(_0x1c217b),
        _0x1377ff = _0x49dfef.get(_0xb6f7bf, "resoultCode", _0x41e108);
      if (_0x1377ff == 0) {
        this.log(
          "完成任务[" + _0x4b897b + "]成功: " + _0xb6f7bf?.["resoultMsg"],
        );
      } else {
        let _0x59d65d =
          _0xb6f7bf?.["msg"] ||
          _0xb6f7bf?.["resoultMsg"] ||
          _0xb6f7bf?.["error"] ||
          "";
        this.log(
          "完成任务[" + _0x4b897b + "]错误[" + _0x1377ff + "]: " + _0x59d65d,
        );
      }
    } catch (_0x574cb0) {
  ...
  async polymerize(_0x2beade, _0x3610fd = {}) {
    ...
    try {
      ...
      let _0x493039 = {
        ...
        { result: _0x2c3e91, statusCode: _0x3c5244 } =
          await this.request(_0x493039),
        _0x43d9c9 = _0x49dfef.get(_0x2c3e91, "resoultCode", _0x3c5244);

      if (_0x43d9c9 == 0) {
        this.log(
          "完成任务[" + _0x27bccc + "]成功: " + _0x2c3e91?.["resoultMsg"],
        );
      } else {
        let _0x402f9a =
          _0x2c3e91?.["msg"] ||
          _0x2c3e91?.["resoultMsg"] ||
          _0x2c3e91?.["error"] ||
          "";
        ...
        this.log(
          "完成任务[" + _0x27bccc + "]错误[" + _0x43d9c9 + "]: " + _0x402f9a,
        );
      }
    } catch (_0xc860ab) {
  ...
  async food(_0x7cbaa1, _0x4b0ab1 = {}) {
    ...
    try {
      ...
      if (_0x117b58 == 0) {
        ...
        if (_0x156b8d?.["levelUp"]) {
          ...
          this.log(
            "宠物已升级到[LV." +
              _0x265b8d +
              "], 获得: " +
              _0x156b8d?.["currLevelRightList"][0]?.["righstName"],
            _0x2eec5b,
          );
        }
      } else {
        ...
        this.log(
          "第" + _0x7cbaa1 + "次喂食失败[" + _0x117b58 + "]: " + _0x14117b,
        );
  ...
  async getParadiseInfo(_0x4c16d3 = {}) {
    ...
    try {
      ...
      // 第一次请求
      {
        ...
        let { result: _0x13b7df, statusCode: _0x1e6dfd } =
      ...
      // 第二次请求
      {
        ...
        let { result: _0x1334dd, statusCode: _0x363378 } =
            await this.request(_0x2d8a6c),
        ...
        if (_0xf71230 == 0) {
          ...
          this.log(
            "宠物等级[Lv." +
              _0x41df23?.["level"] +
              "], 升级进度: " +
              _0x41df23?.["growthValue"] +
              "/" +
              _0x41df23?.["fullGrowthCoinValue"],
            _0x268241,
          );
        } else {
          let _0x1036a5 =
            _0x1334dd?.["msg"] ||
            _0x1334dd?.["resoultMsg"] ||
            _0x1334dd?.["error"] ||
            "";
  ...
  async getLevelRightsList(_0x3ea0a7 = {}) {
    ...
    try {
      ...
      let _0x5a0971 = {
        ...
        { result: _0x4cf13d, statusCode: _0x5e92a4 } =
      ...
      if (_0x4cf13d?.["currentLevel"]) {
        ...
        for (let _0x1ab325 of _0x4cf13d[_0x53ddf4] || []) {
          ...
          (_0x59ef49?.["match"](/\d+元话费/) ||
            _0x59ef49?.["match"](/专享\d+金豆/)) &&
            (await this.getConversionRights(_0x1ab325, _0x1f1006)) &&
            (_0x1f1006 = true);
        }
      } else {
        let _0x4ff776 =
          _0x4cf13d?.["msg"] ||
          _0x4cf13d?.["resoultMsg"] ||
          _0x4cf13d?.["error"] ||
          "";
  ...
  async getConversionRights(_0xca19ef, _0x28066a, _0x21f772 = {}) {
    ...
    try {
      ...
      let _0x5ed3b5 = {
        ...
        { result: _0x409ea1, statusCode: _0x3fb426 } =
          await this.request(_0x5ed3b5),
        _0x17b3d0 = _0x49dfef.get(
          _0x409ea1,
          "code",
      ...
      if (_0x17b3d0 == 200) {
        if (
          !(
            _0x409ea1?.["rightsStatus"]?.["includes"]("已兑换") ||
        ...
        let _0x267dcb =
          _0x409ea1?.["msg"] ||
          _0x409ea1?.["resoultMsg"] ||
          _0x409ea1?.["error"] ||
          "";
        this.log(
          "查询权益[" + _0x5d6f72 + "]失败[" + _0x17b3d0 + "]: " + _0x267dcb,
        );
      }
    } catch (_0x1c9805) {
  ...
  async conversionRights(_0x1258fb, _0x5ee37a = {}) {
    ...
    try {
      ...
      let _0x259df8 = {
        ...
        { result: _0x24b720, statusCode: _0x2867ce } =
      ...
      if (_0x1caee2 == 0) {
        ...
        let _0x58c8d6 =
          _0x24b720?.["msg"] ||
          _0x24b720?.["resoultMsg"] ||
          _0x24b720?.["error"] ||
          "";
        this.log(
          "兑换权益[" + _0x285002 + "]失败[" + _0x1caee2 + "]: " + _0x58c8d6,
        );
      }
    } catch (_0x2f6eb8) {
  ...
  async get_usercode(_0x410326 = {}) {
    try {
      ...
      let { statusCode: _0x1897af, headers: _0xab67f2 } =
          await this.request(_0x4ad8d0),
        _0x40ae2f = _0xab67f2?.["location"]?.["match"](/usercode=(\w+)/);
      _0x40ae2f
        ? await this.codeToken(_0x40ae2f[1])
        : this.log("获取code失败[" + _0x1897af + "]");
    } catch (_0x3b0319) {
  ...
  async codeToken(_0x5551c8, _0x4c3418 = {}) {
    try {
      ...
      let { result: _0x1e1031, statusCode: _0x4829ec } =
  ...
  async watchLiveInit(_0x410248 = {}) {
    try {
      ...
      let { result: _0x15080d, statusCode: _0x39b570 } =
  ...
  async watchLive(_0x2df12e, _0x578beb, _0x1de0d1 = {}) {
    try {
      ...
      let { result: _0x5c4954, statusCode: _0x1ad01d } =
      ...
      if (_0x4e4cbf == 0) {
        ...
        let _0x132d1d =
          _0x5c4954?.["msg"] ||
          _0x5c4954?.["resoultMsg"] ||
          _0x5c4954?.["error"] ||
          _0x5c4954?.["msg"] ||
          "";
        this.log(
          "观看直播[" + _0x2df12e + "]失败[" + _0x4e4cbf + "]: " + _0x132d1d,
        );
      }
    } catch (_0x32ce3f) {
  ...
  async watchVideo(_0x37b577, _0x3a94a2 = {}) {
    try {
      ...
      let { result: _0x3d06a2, statusCode: _0xa801d9 } =
      ...
      if (_0x33f743 == 0) {
        ...
        let _0x597186 =
          _0x3d06a2?.["msg"] ||
          _0x3d06a2?.["resoultMsg"] ||
          _0x3d06a2?.["error"] ||
          _0x3d06a2?.["msg"] ||
          "";
        this.log(
          "观看短视频[" + _0x37b577 + "]失败[" + _0x33f743 + "]: " + _0x597186,
        );
      }
    } catch (_0x42a411) {
  ...
  async like(_0x3605f0, _0x42d468 = {}) {
    try {
      ...
      let { result: _0x15cd63, statusCode: _0x550c11 } =
      ...
      if (_0x3cb60d == 0) {
        ...
        let _0x12573c =
          _0x15cd63?.["msg"] ||
          _0x15cd63?.["resoultMsg"] ||
          _0x15cd63?.["error"] ||
          _0x15cd63?.["msg"] ||
          "";
        this.log(
          "点赞直播间[" + _0x3605f0 + "]失败[" + _0x3cb60d + "]: " + _0x12573c,
        );
      }
    } catch (_0x33a0d8) {
  ...
  async sharingGetGold(_0x5cc2cd = {}) {
    try {
      let _0x5957b6 = {
        ...
        { result: _0x36023a, statusCode: _0x5ade7c } =
          await this.request(_0x5957b6),
        _0x3bb612 = _0x49dfef.get(
          _0x36023a?.["responseData"],
          "resultCode",
          -1,
        );
      if (_0x3bb612 == "0000") {
        ...
        let _0x1fc39a =
          _0x36023a?.["msg"] ||
          _0x36023a?.["responseData"]?.["resultDesc"] ||
          _0x36023a?.["error"] ||
          _0x36023a?.["msg"] ||
          "";
  ...
  async month_jml_preCost(_0x3e12ef = {}) {
    ...
    try {
      let _0x54e4a2 = {
        ...
        { result: _0x19ae9b, statusCode: _0x219a77 } =
  ...
  async month_jml_receive(_0x5aaffc = {}) {
    ...
    try {
      ...
      let _0x4fe3a1 = {
        ...
        { result: _0x16a4a1, statusCode: _0x389615 } =
  ...
  async month_jml_getCount(_0x1eebce = {}) {
    ...
    try {
      ...
      let _0x1d2de9 = {
        ...
        { result: _0xf1b29a, statusCode: _0x4204df } =
          await this.request(_0x1d2de9),
        _0x4704a8 = _0x49dfef.get(_0xf1b29a, "code", -1);
      if (_0x4704a8 == 0) {
        let _0x141535 =
            _0xf1b29a?.["video"]?.["map"]((_0x33886d) => _0x33886d.videoType) ||
            [],
          _0x2fb772 = _0x131d2d.filter(
            (_0x5bb71b) => !_0x141535.includes(_0x5bb71b),
          ),
          _0x22a4b1 = false;
        ...
        let _0x330a5e =
          _0xf1b29a?.["msg"] ||
          _0xf1b29a?.["resoultMsg"] ||
          _0xf1b29a?.["error"] ||
          "";
        this.log(
          "查询看视频得抽奖机会次数失败[" + _0x4704a8 + "]: " + _0x330a5e,
        );
      }
    } catch (_0x1c46ec) {
  ...
  async month_jml_addVideoCount(_0x10070c, _0x588069 = {}) {
    ...
    try {
      ...
      let _0x2b00ee = {
        ...
        { result: _0x8dff4, statusCode: _0x6fd216 } =
  ...
  async month_jml_refresh(_0xcca85f = {}) {
    ...
    try {
      ...
      let _0x5ab84e = {
        ...
        { result: _0x764f77, statusCode: _0x2cc71c } =
  ...
  async month_jml_lotteryRevice(_0x5bf2d6 = {}) {
    ...
    try {
      ...
      let _0x57d2e2 = {
        ...
        { result: _0x361574, statusCode: _0x1225b9 } =
  ...
  async auth_login(_0x16dd5f = {}) {
    ...
    try {
      let _0x59ca25 = this.ticket,
        ...
        _0x28641d = {
          ...
          backUrl: encodeURIComponent(
            "https://wapact.189.cn:9001/JinDouMall/JinDouMall_luckDraw.html?ticket=" +
              _0x59ca25,
          ),
          platformCode: "P201010301",
          loginType: 2,
        },
        { result: _0x16b3c5, statusCode: _0x3b6fb9 } = await this.rpc_request(
          _0xa64474,
          "POST",
          _0x28641d,
        ),
      ...
      if (_0x25f5c8 == 0) {
        let { token: _0x202a28, sessionId: _0x274600 } = _0x16b3c5?.["biz"];
  ...
  async queryInfo(_0x3da8a0 = {}) {
    try {
      let _0xc5f478 = new URL(
        "https://wapact.189.cn:9001/gateway/golden/api/queryInfo",
      );
      _0xc5f478.searchParams.append("_", Date.now().toString());
      let { result: _0x3bab08, statusCode: _0x42dda4 } =
  ...
  async queryTurnTable(_0x12dce0 = {}) {
    try {
      let _0x5dccd4 = new URL(
        "https://wapact.189.cn:9001/gateway/golden/api/queryTurnTable",
      );
      _0x5dccd4.searchParams.append("userType", "1");
      _0x5dccd4.searchParams.append("_", Date.now().toString());
      let { result: _0x2ad2d5, statusCode: _0x5a8d92 } =
      ...
      if (_0x2b1c98 == 0) {
        ...
        _0x15becc
          ? await this.lottery_check(_0x15becc, _0x2b2dfc)
          : this.log("没有获取到转盘抽奖ID");
      } else {
  ...
  async lottery_do(_0x5149a7, _0xc5a8fd = {}) {
    try {
      let _0x1794f8 = new URL(
        "https://wapact.189.cn:9001/gateway/golden/api/lottery",
      );
      const _0x5e6ddf = {
        activityId: _0x5149a7,
      };
      let { result: _0x50d02f, statusCode: _0x69dd47 } = await this.rpc_request(
          _0x1794f8,
          "POST",
          _0x5e6ddf,
        ),
      ...
      if (_0x301247 == 0) {
        this.coin =
          _0x50d02f?.["biz"]?.["amountTotal"] || this.coin - xiaoHaoCount;
        let _0x3d75c1 = _0x50d02f?.["biz"]?.["resultCode"],
          _0x2f6e42 = "";
        switch (_0x3d75c1) {
          case "0": {
            let _0x420d18 =
              _0x50d02f?.["biz"]?.["resultInfo"]?.["winTitle"] || "空气";
            const _0x580cdf = {
              notify: true,
            };
...
!(async () => {
  ...
  .catch((_0x3fccb3) => _0x49dfef.log(_0x3fccb3))
  .finally(() => _0x49dfef.exitNow());
...
function _0x5370a4(_0x24412c) {
  return new (class {
    ...
    get(_0x2ecf4d, _0x5800fb, _0x1ff76e = "") {
      ...
      _0x2ecf4d?.["hasOwnProperty"](_0x5800fb) &&
    ...
    pop(_0x2ae8ec, _0xbb54f6, _0x9c8563 = "") {
      ...
      _0x2ae8ec?.["hasOwnProperty"](_0xbb54f6) &&
        ((_0x213044 = _0x2ae8ec[_0xbb54f6]), delete _0x2ae8ec[_0xbb54f6]);
      return _0x213044;
    }
    ...
    read_env(_0x412e83) {
      ...
      for (let _0x2b0da2 of _0x1267c5.filter((_0x22b120) => !!_0x22b120)) {
        for (let _0x4465a3 of _0x2b0da2
          .split(_0x1876a7)
          .filter((_0x3c7dca) => !!_0x3c7dca)) {
      ...
      if (!this.userCount) {
        ...
        this.log(
          "未找到变量，请检查变量" +
            _0x4aec53.map((_0x56423f) => "[" + _0x56423f + "]").join("或"),
          _0x3d5d5,
        );
        return false;
      }
    ...
    time(_0x43e381, _0x1822e0 = null) {
      ...
      /(y+)/.test(_0x43e381) &&
        (_0x43e381 = _0x43e381.replace(
          RegExp.$1,
          (_0x1de2f7.getFullYear() + "").substr(4 - RegExp.$1.length),
        ));

      for (let _0x2cfbd9 in _0x180e96)
        new RegExp("(" + _0x2cfbd9 + ")").test(_0x43e381) &&
          (_0x43e381 = _0x43e381.replace(
            RegExp.$1,
            1 == RegExp.$1.length
              ? _0x180e96[_0x2cfbd9]
              : ("00" + _0x180e96[_0x2cfbd9]).substr(
                  ("" + _0x180e96[_0x2cfbd9]).length,
                ),
          ));
    ...
    padStr(_0x397014, _0x4fcca2, _0x1abd3c = {}) {
      let _0x10354b = _0x1abd3c.padding || "0",
        ...
        _0x26e87b =
          _0x4fcca2 > _0x3b33af.length ? _0x4fcca2 - _0x3b33af.length : 0,
        _0x3bb60f = "";
      ...
      _0x39ed4e == "r"
        ? (_0x3b33af = _0x3b33af + _0x3bb60f)
        : (_0x3b33af = _0x3bb60f + _0x3b33af);
      return _0x3b33af;
    }
    ...
    randomPattern(_0x369f7e, _0x4006d8 = "abcdef0123456789") {
      ...
      for (let _0x8e9314 of _0x369f7e) {
        if (_0x8e9314 == "x") {
          _0x3140cf += _0x4006d8.charAt(
            Math.floor(Math.random() * _0x4006d8.length),
          );
        } else {
          _0x8e9314 == "X"
            ? (_0x3140cf += _0x4006d8
                .charAt(Math.floor(Math.random() * _0x4006d8.length))
                .toUpperCase())
            : (_0x3140cf += _0x8e9314);
        }
      }
    ...
    randomString(_0x33254d, _0x5f4306 = "abcdef0123456789") {
      ...
      for (let _0x475f61 = 0; _0x475f61 < _0x33254d; _0x475f61++) {
        _0x440af6 += _0x5f4306.charAt(
          Math.floor(Math.random() * _0x5f4306.length),
        );
      }
    ...
    async exitNow() {
      ...
      this.log(
        "[" + this.name + "]运行结束，共运行了" + _0x52abd1 + "秒",
        _0x4bb8d6,
      );
      process.exit(0);
    }
    ...
    async wait_until(_0x3145a4, _0x3938d8 = {}) {
      ...
      if (_0x539462 > _0x1929a1) {
        ...
        _0x155654.log(
          "离目标时间[" + _0x213d55 + "]大于" + _0x1929a1 / 1000 + "秒,不等待",
          _0x533822,
        );
      } else {
        const _0x436e20 = {
